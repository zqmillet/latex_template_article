...
\newtcblisting[auto counter, number within = section]{codebox}[1][]{%
  ...
  overlay         = {
  \draw ([xshift = 6mm]frame.south west) -- ([xshift = 6mm]title.south west);\draw (frame.south west) -- (frame.south east);\draw (frame.north west) -- (frame.north east);\draw (title.south west) -- (title.south east);},
  #1%
}
